...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "GEMINI"         # 用户名
UUID = "21c0373c-fd3c-48fe-a066-89a379e43431"                     # UUID，留空则自动生成
PORT = 7534                  # Vmess端口，留空或0则自动生成
DOMAIN = "steamlit.037518.xyz"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiOTdhNzQ3ZGZiMjgyMjc3YmNkYWZhNzg5OGUzMTliODIiLCJ0IjoiZGU5ZWQ5YTktMWVjOC00YWFmLTk5ODYtOTc4NWVmMmI0M2I0IiwicyI6Ik1HVmpOVEZpWW1RdE5tWTBPUzAwTXpZNExUa3lNV0l0T1RKaVpUazNPREprT0RVeiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
